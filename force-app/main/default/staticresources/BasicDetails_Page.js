angular.module('cp_app').controller('basicDetails_ctrl', function ($scope, $sce, $rootScope) {
    ...
    $scope.getApplicantProjectDetails = function () {
        ...
        WorkshopController2.getBasicDetails($rootScope.proposalId, function (result, event) {
            if (event.status) {
                debugger;
                $scope.isLoading = true;
    ...
    $scope.saveBasicDetails = function () {
        ...
        */
        ...
        WorkshopController2.insertBasicDetails2($scope.applicantDetails, day, month, year, endday, endmonth, endyear, $rootScope.contactId, $rootScope.proposalId, 'Workshop', function (result, event) {
            if (event.status && result != null) {
                debugger;
