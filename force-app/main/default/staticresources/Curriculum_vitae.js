angular.module('cp_app').controller('CV_Ctrl', function ($scope, $rootScope) {
    ...
    $scope.checkEmail = function (email, contId) {
        ...
        WorkshopController2.checkEmail(email, contId, function (result, event) {
            debugger;
            if (event.status) {
                debugger;
                if (result.length > 0) {
    ...
    $scope.deleteEducationRow = function (eduId) {
        ...
        WorkshopController2.deleteEducationWorkshop(eduId, function (result, event) {
            if (event.status) {
                debugger;
                swal(
                    'Success',
    ...
    $scope.deleteEmploymentWorkshop = function (empId) {
        ...
        WorkshopController2.deleteEmploymentWorkshop(empId, function (result, event) {
            if (event.status) {
                debugger;
                swal(
                    'Success',
    ...
    $scope.getCoordCVDetails = function () {
        ...
        WorkshopController2.getCoordCVDetails($rootScope.candidateId, $rootScope.apaId, $rootScope.proposalId, function (result, event) {
            ...
            if (event.status) {
                ...
                if (result == null || result.length == 0) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        if (result[i].Applicant_Proposal_Associations__r[0].Is_Coordinator__c == true) {
    ...
    $scope.saveCoordCVDetails = function () {
        ...
        for (var i = 0; i < $scope.allDetailList.length; i++) {
           ...
           delete ($scope.allDetailList[i]['Applicant_Proposal_Associations__r']);
        }

        for (var i = 0; i < $scope.educationDetails.length; i++) {
            delete ($scope.educationDetails[i]['$$hashKey']);
             delete ($scope.educationDetails[i]['Applicant_Proposal_Associations__r']);
        }
        for (var i = 0; i < $scope.employmentDetails.length; i++) {
            delete ($scope.employmentDetails[i]['$$hashKey']);
             delete ($scope.employmentDetails[i]['Applicant_Proposal_Associations__r']);
        }
        ...
        WorkshopController2.SaveWorkshopContactDetails($scope.allDetailList, $scope.educationDetails, $scope.employmentDetails, $rootScope.apaId, $rootScope.proposalId, function (result, event) {
            debugger;
            if (event.status) {
                debugger;
                swal(
                    'Success',
                    'Your Curriculum Vitae have been Saved successfully.',
                    'success'
                );
    ...
    $scope.saveAllDetails = function () {
            ...
            if ($scope.allDetailList.Education_Details__r != undefined) {
                for (var i = 0; i < $scope.allDetailList.Education_Details__r.length; i++) {
                    ...
                    if ($scope.allDetailList.Education_Details__r[i].Percentage_cgpa__c == "Percentage") {
                        ...
                        if ($scope.allDetailList.Education_Details__r[i].Percentage__c == 0) {
                            swal('Info', 'Please enter Percentage more than 0.', 'info');
                            $("#txtPer" + i + "").addClass('border-theme');
                            return;
                        }
                    ...
                    if ($scope.allDetailList.Education_Details__r[i].Percentage_cgpa__c == "CGPA") {
                        ...
                        if ($scope.allDetailList.Education_Details__r[i].CGPA__c == 0) {
                            swal('Info', 'Please enter CGPA more than 0.', 'info');
                            $("#txtPer" + i + "").addClass('border-theme');
                            return;
                        }
        ...
        // ApplicantPortal_Contoller.SaveWorkshopContactDetails($scope.allDetailList, $scope.educationDetails, $scope.employmentDetails, function (result, event) {
        WorkshopController2.SaveWorkshopContactDetails($scope.allDetailList, $scope.educationDetails, $scope.employmentDetails, function (result, event) {
            debugger;
            if (event.status) {
                debugger;
                swal(
